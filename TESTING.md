...
![Add category form](screenshots/loginscreenshot.png)
...
![Categories page](screenshots/loginscreenshot.png)
...
![Add ingredient form](screenshots/loginscreenshot.png) 
...
![Ingredients page](screenshots/loginscreenshot.png) 

### Tested add recipe form validation
[Add recipe](https://houseplantr-v1.herokuapp.com/add_houseplant)
- Tested all the fields are required fields and cannot be left blank: 
...
![Add recipe page](screenshots/add-houseplant_layout.png)
